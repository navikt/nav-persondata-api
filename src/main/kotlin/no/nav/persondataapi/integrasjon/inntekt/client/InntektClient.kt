...
class InntektClient(
    ...
    fun hentInntekter(
        ...
        runCatching {
            ...
            onFailure = { error ->
                val erKjentSkatteetatenFeil = error.message?.contains("IM-006", ignoreCase = true) == true
                val resultType =
                    when {
                ...
                if (erKjentSkatteetatenFeil) {
                    log.warn("Inntekt utilgjengelig — kjent Skatteetaten-feil (IM-006): ${error.message}")
                } else {
