...
class ArbeidsforholdServiceTest {
	...
	@Test
	fun `skal ha unike id på ulike arbeidsforhold også når saksbehandler ikke har tilgang`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal ha lik id på like arbeidsforhold også  når saksbehandler ikke har tilgang`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal ha ullik id på uklike arbeidsforhold også når saksbehandler ikke har tilgang`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal returnere PersonIkkeFunnet når Aareg returnerer 404`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal returnere IngenTilgang når Aareg returnerer 403`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal returnere FeilIBaksystem når Aareg returnerer 500`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal returnere FeilIBaksystem når Aareg returnerer annen feilkode`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal returnere tomme lister når person ikke har arbeidsforhold`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal separere løpende og historiske arbeidsforhold korrekt`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal mappe arbeidsforhold med organisasjonsinformasjon fra Ereg`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal håndtere ukjent organisasjon når Ereg ikke har data`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal mappe ansettelsesdetaljer korrekt`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal håndtere flere arbeidsforhold for samme person`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
	...
	@Test
	fun `skal deduplisere organisasjonsnumre ved Ereg-oppslag`() =
		runBlocking {
			val brukertilgangService = mockk<BrukertilgangService>()
			val aaregClient = mockk<AaregClient>()
			val eregClient = mockk<EregClient>()
