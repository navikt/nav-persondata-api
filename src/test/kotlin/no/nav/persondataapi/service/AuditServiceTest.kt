...
class AuditServiceTest {
    ...
    internal fun `skal lage cef med korrekt format`() {
        ...
        val expected =
            "CEF:0|watson\\oppslag-bruker|oppslag-bruker|1.0|audit:access|oppslag-bruker" +
                "|INFO|end=1761217044817 duid=12345678901 suid=Z12345" +
                " request=/oppslag/personbruker flexString1Label=Decision flexString1=Permit"
        ...
        val msg =
            auditLogger.createCefMessage(
                ...
                "12345678901",
                operasjon = RevisjonsLogger.Operasjon.READ,
