...
import no.nav.persondataapi.integrasjon.aap.meldekort.domene.AAPMeldekortRespons
...
class AapMeldekortResponsTest {
    ...
    fun KanLese2025Respons(){
        ...
        val aapMeldekortRespons: AAPMeldekortRespons = JsonUtils.fromJson(jsonString)
        println()
    }
    @Test
